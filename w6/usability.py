...
print("="*50)
print(f"Varianza de los tiempos: {np.var(tiempos):.2f}")
print(f"Varianza de los errores: {np.var(errores):.2f}")
print(f"Varianza de la satisfacción: {np.var(satisfaccion):.2f}")
